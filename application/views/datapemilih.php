                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="staticModalLabel">Konfirmasi
                                            <hr>
                                            Apakah anda ingin hapus mahasiswa <b><?= ucwords($namasiswa); ?></b> ?
                                        </h5>
                                    </div>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="nis" name="nis" placeholder="NIS . . ." class="form-control" readonly value="<?= $nis; ?>">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3"><label for="disabled-input" class=" form-control-label">Passowrd</label></div>
                                                <div class="col-12 col-md-9">
                                                    <input type="password" id="password" name="password" placeholder="NIS . . ." readonly class="form-control" value="<?= $password; ?>">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3"><label for="disabled-input" class=" form-control-label">Nama Pemilih</label></div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="nama" name="nama" placeholder="Nama . . ." class="form-control" value="<?= $namasiswa; ?>">
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="modal fade" id="absen" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Apakah anda yakin ingin absen semua data pemilih ?</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Tidak</button>
                        <form action="<?= base_url('datapem/absen') ?>">
                            <input type="submit" class="btn btn-primary" value="Ya">
                        </form>
                    </div>
                </div>
        ...
        <div class="modal fade" id="batalabsen" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Apakah anda yakin ingin batal absen semua data pemilih ?</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Tidak</button>
                        <form action="<?= base_url('datapem/batalabsen') ?>">
                            <input type="submit" class="btn btn-primary" value="Ya">
                        </form>
                    </div>
                </div>
        ...
        <div class="modal fade" id="resetpilihan" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Apakah anda yakin ingin reset pilihan semua data pemilih ?</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Tidak</button>
                        <form action="<?= base_url('datapem/resetpilihan') ?>">
                            <input type="submit" class="btn btn-primary" value="Ya">
                        </form>
                    </div>
                </div>
